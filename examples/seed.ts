...
const initialPermissions = [
  ...
  // Permisos de administración
  {
    ...
    resource: "admin",
    action: "dashboard",
    description: "Acceder al dashboard de administración",
  },
  {
    name: "admin.settings",
    resource: "admin",
  ...
  },
  {
    ...
    resource: "admin",
    action: "analytics",
    description: "Ver analytics del sistema",
  },
];
      ...
      try {
        ...
        if (result && result.success && result.user) {
          ...
          for (const roleName of user.roles) {
            const assignResult = await authService.assignRole(
              result.user.id,
              roleName,
            );
            if (assignResult) {
              ...
              console.log(
                `    ❌ Error asignando rol ${roleName} a ${user.email}:`,
                assignResult,
              );
            }
          }
